...
title_info_daily_shipped_revenue_link as (
    select *
    from {{ ref('title_info_daily_shipped_revenue_link') }} 
),
final as (
    select distinct 
        ...
        -- ,posat.lbb_price
        -- ,posat.rep_oos
    from daily_shipped_revenue_sat as posat
    join title_info_daily_shipped_revenue_link as polnk 
